...
public class Patroll : EnemyAction
{
    public float speed;
    ...
    {
        var goingToGround = Physics2D.OverlapCircle(checkEdge.position + new Vector3(addedStopDistance * (transform.localScale.x / 4), 0f, 0f), 0.04f, GetComponent<CyborgEnemy>().whatIsGround);
